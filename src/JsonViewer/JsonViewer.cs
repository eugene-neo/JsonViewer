...
namespace Opensource.Json.Viewer
{
    ...
    public partial class JsonViewer : UserControl
    {
        ...
        public JsonViewer()
        {
            ...
            {
                MessageBox.Show(
                    String.Format(Resources.ConfigMessage, e.Message),
                    "Json Viewer",
        ...
        [Browsable(false)]
        public TreeView TreeViewJson
        {
            get { return this.tvJson; }
        }
        ...
        public void DisplaysTheFindPrompt()
        {
            this.pnlFind.Visible = true;
            this.txtFind.Focus();
        }

        public void SelectsAllTextInTheTextbox()
        {
            this.txtJson.SelectAll();
        }
        public void DeleteSelectedTextInTheTextbox()
        {
            this.txtJson.SelectedText = "";
        }
        ...
        {
            get { return _errorDetails._err != null; }
        }
        ...
        public void PasteTextIntoTheTextbox()
        {
            this.txtJson.Paste();
        }

        public void CopyTextIntoTheClipboard()
        {
            this.txtJson.Copy();
        }
    }
